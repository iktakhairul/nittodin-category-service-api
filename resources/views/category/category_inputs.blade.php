                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ !empty($editRow) ? url('category/update', $editRow->id) : url('category/store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter Category Name" value="{{!empty($editRow) ? $editRow->name : 'Not Found!'}}" style="width: 350px;">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="category_code" id="category_code" placeholder="Enter Category Code" class="form-control" value="{{!empty($editRow) ? $editRow->category_code : 'Not Found!'}}" style="width: 350px;">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="serial_no">Serial No<i class="text-danger">*</i> :</label>
                                        <input type="text" name="serial_no" id="serial_no" class="form-control" placeholder="Enter Serial No" value="{{!empty($editRow) ? $editRow->serial_no : 'Not Found!'}}" style="width: 350px;">
                                    </div>
                                </div>
                                <!-- row -->
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <textarea type="text" name="short_details" id="short_details" placeholder="Enter short details for category." class="form-control" style="width: 350px;">{{!empty($editRow) ? $editRow->short_details : 'Enter short details for category.'}}</textarea>
                                    </div>
                                </div>
                                <!-- row -->
                                <div class="row">
