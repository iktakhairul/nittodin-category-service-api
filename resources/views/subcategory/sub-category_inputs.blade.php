...
@section('title',(!empty($editRow) ? 'Edit ' . $editRow->name : 'Add ') . 'Subcategory')

@section('content')
    <section class="content-header">
        <h1 class="breadcrumb ml-5 mt-4">
            <i class="fa fa-box"></i><a class="ml-2 mr-2" href="{{url('sub-categories')}}">Subcategory</a>
            {{ (!empty($editRow) ? '/ Edit - ' . $editRow->name : '/ Add New Subcategory') }}
        </h1>
    </section>
    <hr>
